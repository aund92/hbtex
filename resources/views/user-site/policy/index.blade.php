            ...
            <div class="row">
                <div class="col-md-9 col-sm-9 col-xs-12 box-detail-notification">
                    <div class="info-notification">
                        <div class="title">
                            <h4>
                                Chính sách bảo vệ thông tin trên hbtex.vn
                            </h4>
                        </div>
                        ...
                        <div class="content-notification">
                            ...
                            <p style="text-align: justify;">- Các thông tin giao dịch thực hiện trên Sàn giao dịch TMĐT hbtex.vn sẽ được ban quản trị kiểm soát.</p>
                            <p style="text-align: justify;">- Khi người tiêu dùng mua hàng hóa hoặc dịch vụ phát sinh mâu thuẫn với nhà cung cấp hoặc bị tổn hại lợi ích hợp pháp,&nbsp;hbtex.vn&nbsp;sẽ&nbsp;cung cấp cho người tiêu dùng thông tin đăng ký của nhà cung cấp ngay sau khi nhận được yêu cầu của người mua, tích cực hỗ trợ người tiêu dùng bảo vệ quyền và lợi ích hợp pháp của bản thân.</p>
                            <p style="text-align: justify;">- Bảo vệ thông tin cá nhân của khách hàng trên&nbsp;hbtex.vn</p>
                            <p style="text-align: justify;">Hatex hoàn toàn tôn trọng tính riêng tư và cam kết sẽ bảo mật thông tin cá nhân của thành viên sử dụng dịch vụ của hbtex.vn. Chính sách bảo vệ thông tin cá nhân được trình bày dưới đây thể hiện những cam kết của Hatex trong việc thu thập, sử dụng và bảo vệ thông tin cá nhân của người sử dụng.</p>
                            ...
                            <p style="text-align: justify;">Địa chỉ liên lạc chính thức của Sàn giao dịch TMĐT hbtex.vn là:</p>
                            ...
                            <p style="text-align: justify;">E-mail:&nbsp;<a href="mailto:thongtin@hbtex.vn">thongtin@hbtex.vn</a>&nbsp;hoặc info@hbtex.vn</p>
                        </div>
                        <div id="fb-root">
                            <div class="fb-like" data-href="https://hbtex.vn/thong-bao/chinh-sach-bao-ve-thong-tin-tren-hatexvn.html" data-layout="button_count" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
                        </div>
                        <div id="fb-root1">
                            <div class="fb-comments" data-href="https://hbtex.vn/thong-bao/chinh-sach-bao-ve-thong-tin-tren-hatexvn.html" data-numposts="5" data-width="100%"></div>
                        </div>
                    </div>
                    <div class="related-notification weight">
                        ...
                        <div class="content-related-notification">
                            <table class="table table-hover table-responsive">
                                ...
                                <tr>
                                    <td>
                                        <a href="https://hbtex.vn/thong-bao/thong-bao-thay-doi-ten-don-vi-quan-ly-san-tmdt-hatexvn.html"><i class="icon-event"></i>
                                            Thông báo thay đổi tên đơn vị quản lý sàn TMĐT hbtex.vn

                                            <span>Thông báo thay đổi tên đơn vị quản lý sàn TMĐT hbtex.vn</span>
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a href="https://hbtex.vn/thong-bao/thong-bao-quy-dinh-ve-dang-ban-san-pham-tren-hatexvn.html"><i class="icon-event"></i>
                                            Thông báo: Quy định về đăng bán sản phẩm trên hbtex.vn

                                            <span>Thông báo: Quy định về đăng bán sản phẩm trên hbtex.vn</span>
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a href="https://hbtex.vn/thong-bao/thong-bao-lich-nghi-tet-nguyen-dan-canh-ty-2020.html"><i class="icon-event"></i>
                                ...
                                <tr>
                                    <td>
                                        <a href="https://hbtex.vn/thong-bao/thong-bao-lich-nghi-le-304-va-152019.html"><i class="icon-event"></i>
                                ...
                                <tr>
                                    <td>
                                        <a href="https://hbtex.vn/thong-bao/chuong-trinh-ho-tro-tai-trien-lam-ket-qua-nghien-cuu-khcn-vung-dbsh-va-techfest-haiphong-2018.html"><i class="icon-event"></i>
                                ...
                                <tr>
                                    <td>
                                        <a href="https://hbtex.vn/thong-bao/chinh-thuc-ra-mat-san-giao-dich-cong-nghe-va-thiet-bi-truc-tuyen-hatexvn-phien-ban-nang-cap-2018.html"><i class="icon-event"></i>
                                            Chính thức ra mắt Sàn giao dịch công nghệ và thiết bị trực tuyến hbtex.vn phiên bản nâng cấp 2018

                                            <span>Chính thức ra mắt Sàn giao dịch công nghệ và thiết bị trực tuyến hbtex.vn phiên bản nâng cấp 2018</span>
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a href="https://hbtex.vn/thong-bao/chinh-sach-bao-ve-thong-tin-tren-hatexvn.html"><i class="icon-event"></i>
                                            Chính sách bảo vệ thông tin trên hbtex.vn

                                            <span>Chính sách bảo vệ thông tin trên hbtex.vn</span>
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a href="https://hbtex.vn/thong-bao/thong-bao-lich-nghi-tet-nguyen-dan-2018.html"><i class="icon-event"></i>
                                ...
                                <tr>
                                    <td>
                                        <a href="https://hbtex.vn/thong-bao/thong-bao-lich-nghi-le-quoc-khanh-29.html"><i class="icon-event"></i>
                                ...
                                <tr>
                                    <td>
                                        <a href="https://hbtex.vn/thong-bao/tri-an-khach-hang---uu-dai-dac-biet-danh-cho-thanh-vien-trong-thang-82017.html"><i class="icon-event"></i>
                    ...
                    <div class="related-notification weight">
                        ...
                        <div class="content-related-notification">
                            <table class="table table-hover table-responsive">
                                ...
                                <tr>
                                    <td>
                                        <a href="https://hbtex.vn/thong-bao/quy-che-hoat-dong-cua-san-thuong-mai-dien-tu-hatexvn.html"><i class="icon-event"></i>
                                            Quy chế hoạt động của Sàn thương mại điện tử hbtex.vn

                                            <span>Quy chế hoạt động của Sàn thương mại điện tử hbtex.vn</span>
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a href="https://hbtex.vn/thong-bao/cap-nhat-thong-tin-san-pham-chinh-cua-thanh-vien-tren-gian-hang.html"><i class="icon-event"></i>
