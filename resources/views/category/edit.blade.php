            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" id="quickForm" method="POST" action="{{route('category.update', $item->id)}}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="parent_id">Thể Loại Cha</label>
                                    <select class="form-control" id="parent_id" name="parent_id">
                                        <option value="" disabled selected>Chọn Thể Loại</option>
                                        @foreach($theloais as $key => $theloai)
                                            <option value="{{$theloai->id}}"
                                                    @if($theloai->id == old('parent_id')) selected @endif>{{$theloai->category_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
