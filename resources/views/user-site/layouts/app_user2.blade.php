        ...
        <div class="classy-nav-container breakpoint-off" style="background-color: green">
            <div class="container">
                ...
                <nav class="classy-navbar justify-content-between" id="vizewNav">
                    ...
                    <!-- Nav brand -->
                    <a href="{{route('user.home.index')}}" class="nav-brand"><img src="img/core-img/dinhduong.png" alt=""></a>
                            ...
                            <ul>
                                ...
                                @if(isset($categories))
                                    @foreach($categories as $key => $category)
                                        <li><a href="{{route('user.blog.index2', $category->slug)}}">{{$category->category_name}}</a>
                                            @if(count($category->childCategory) >0)
                                                <ul class="dropdown">
                                                    @foreach($category->childCategory as $key2 => $category2)
                                                        <li><a href="{{route('user.blog.index2', $category2->slug)}}">- {{$category2->category_name}}</a></li>
                                    ...
                                    @endforeach
                                @endif
                                <li ><a href="{{route('user.dinhduong.index')}}">Tính KCALO</a></li>
                            </ul>
                        </div>
                        <!-- Nav End -->
                    </div>
