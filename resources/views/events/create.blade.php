            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" id="quickForm" method="POST" action="{{route('event.store')}}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="email">Kiểu</label>
                                    <select class="form-control" id="type" name="type">
                                        <option value="0" @if(old('type') == '0') @endif >Sự Kiện</option>
                                        <option value="1" @if(old('type') == '1') @endif >Thông Báo</option>
