                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="role" name="role">
                                        ...
                                        <option value="user" @if(old('role', $item->role) == \App\Consts\Consts::USER_ROLE) selected @endif >user</option>
                                        <option value="admin" @if(old('role', $item->role) == \App\Consts\Consts::ADMIN_ROLE) selected @endif >admin</option>
{{--                                        <option value="manager" @if(old('role', $item->role) == 'manager') @endif >Manager</option>--}}
                            ...
                            <div class="card-footer">
                                ...
                                <a class="btn btn-info btn-md" href="{{ route("user.index") }}"><i
